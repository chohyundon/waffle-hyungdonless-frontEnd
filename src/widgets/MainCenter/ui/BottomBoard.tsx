   ...
   <>
     <article className={styles.titleContainer}>
       <h1 className={styles.title}>
         ...
         게시글</h1>
       <p className={styles.subTitle}>지금 가장 뜨거운 이야기!<br />
       ...
       {Array.from({ length: 5 }, (_, i) => {
         return (
           <article className={styles.boardContainer} key={i}>
             <h1 className={`${styles.boardRankNumber} ${i <= 2 ? styles.checkNum : styles.noneCheck}`}>{i + 1}</h1>
             ...
             <span className={`${styles.borderBottom} ${i === 4 && styles.borderNone}`}></span>
           </article>
         )
       })}
     </section>
